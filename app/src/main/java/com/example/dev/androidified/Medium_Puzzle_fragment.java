...
public class Medium_Puzzle_fragment extends Fragment {
    ...
    Integer[] MediumPuzzlePics = {R.drawable.yash, R.drawable.sameep, R.drawable.vaishali, R.drawable.shivang,
            R.drawable.harshit, R.drawable.mohit, R.drawable.devesh, R.drawable.shivam_kumar_small} ;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new Puzzle_Adapter(MediumPuzzlePics);
